...
public class  WelcomeActivity extends AppCompatActivity {
  ...
  private static final PageData[] PAGES = new PageData[] {
      new PageData(
          ...
          R.drawable.welcome_road_1,
          R.string.welcome_page_description),
      new PageData(
          R.string.welcome_page_image_classification_title,
          R.drawable.welcome_road_2,
          R.string.welcome_page_image_classification_description),
      new PageData(
          R.string.welcome_page_send,
          R.drawable.welcome_road_3,
          R.string.welcome_page_send_description)
  };
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    next_Button.setOnClickListener(v -> startActivity(new Intent(WelcomeActivity.this, MainActivity.class)));
    ...
    mTabLayout.setOnTabSelectedListener(new TabLayout.OnTabSelectedListener(){
      ...
      public void onTabSelected(TabLayout.Tab tab){
        ...
        if (position==0){
          next_Button.setEnabled(false);
          next_Button.setText("Swipe to step 2");
        }else if (position==1){
          next_Button.setEnabled(false);
          next_Button.setText("Swipe to step 3");
        }else{
          next_Button.setEnabled(true);
          next_Button.setText("Start");
        }
      }
